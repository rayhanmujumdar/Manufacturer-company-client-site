        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 lg:justify-items-center justify-items-start">
          ...
          <div className="mb-6">
            ...
            <ul className="list-none mb-0 flex flex-col items-start">
              ...
              <li>
                 <Link to="/blog" className="text-gray-800 hover:underline hover:text-blue-600">Blogs</Link>
              </li>
              <li>
                 <Link to="/my-portfolio" className="text-gray-800 hover:underline hover:text-blue-600">My Portfolio</Link>
              </li>
              <li>
          ...
          <div className="mb-6">
            <h5 className="uppercase text-left font-bold mb-2.5 text-gray-800">Social</h5>
