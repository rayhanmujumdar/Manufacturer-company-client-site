...
const Footer = () => {
    ...
    return (
        <footer className="bg-gray-100 text-center lg:text-left">
                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 lg:justify-items-center justify-items-start">
                    <div className="mb-6">
                        ...
                        <p className="text-left">
                            There might be many tips and tricks that you can use
                            to get your content seen, but nothing works quite as
                            well as creating high quality content. If you focus
                            on creating unique content that valuable.
                        </p>
                    </div>
                    <div className="mb-6">
            ...
            <div className="text-gray-100 text-center p-4 bg-teal-600 ">
                © {year} Copyright:
