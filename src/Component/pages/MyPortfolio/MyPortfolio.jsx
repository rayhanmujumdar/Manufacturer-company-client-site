                    ...
                    <div className="hero-content p-0 flex-col lg:flex-row-reverse lg:items-start">
                        <div className="text-left md:w-3/4 md:my-0 m-2">
                            ...
                            <div className="border-2 border-gray-400 p-2 rounded-md md:mx-0 mx-2">
                                ...
                                <p className="text-xl">
                                    Hello, My name is Rayhan Mojumdar,
                                    Passionate about crafting immersive and
                                    user-centric web experiences, I am a
                                    dedicated web developer with expertise in
                                    front-end technologies. With a keen eye for
                                    aesthetics and a focus on delivering
                                    exceptional user experiences, I thrive on
                                    translating design concepts into fully
                                    functional websites that captivate and
                                    engage audiences
                                </p>
                                <div className="text-xl pt-10">
                                    ...
                                    <ol className="list-disc pl-10">
                                        ...
                                        <li>
                                            ...
                                            approach, Bootstrap, tailwind css,
                                            Media Queries
                                        </li>
                                ...
                                <div className="text-xl pt-10">
                                    ...
                                    <ol className="list-disc pl-10">
                                        <li>
                                            Collaborative mindset, adept at
                                            working in cross-functional teams to
                                            achieve project objectives
                                        </li>
                                        <li>
                                            Strong problem-solving skills,
                                            capable of debugging and optimizing
                                            code for performance
                                        </li>
                                        <li>
                                            Detail-oriented approach, ensuring
                                            high-quality code that follows
                                            industry best practices
                                        </li>
                                        <li>
                                            Continuously learning and adapting
                                            to new technologies and emerging
