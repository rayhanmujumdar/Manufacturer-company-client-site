            ...
            <div className="text-left md:w-3/4">
              ...
              <ul className="uppercase">
                  ...
                  <li className="grid lg:grid-cols-3 grid-cols-2 gap-x-2 items-center">
                      ...
                      <span className="text-xl lg:block hidden"><i  className="fa-brands fa-html5"></i></span>
                      <progress  className="progress progress-success w-36 h-3" value="80" max="100"></progress>
                  </li>
                  <li className="grid lg:grid-cols-3 grid-cols-2 gap-x-2 items-center">
                      <span className="font-semibold">css</span>
                      <span className="text-xl lg:block hidden"><i  className="fa-brands fa-css3-alt"></i></span>
                      <progress  className="progress progress-success w-36 h-3" value="70" max="100"></progress>
                  </li>
                  <li className="grid lg:grid-cols-3 grid-cols-2 gap-x-2 items-center">
                      <span className="font-semibold">bootstrap</span>
                      <span className="text-xl lg:block hidden"><i  className="fa-brands fa-bootstrap"></i></span>
                      <progress  className="progress progress-success w-36 h-3" value="70" max="100"></progress>
                  </li>
                  <li className="grid lg:grid-cols-3 grid-cols-2 gap-x-2 items-center">
                      <span className="font-semibold">tailwind</span>
                      <span className="text-xl lg:block hidden"><i  className="fa-solid fa-image-landscape"></i></span>
                      <progress  className="progress progress-success w-36 h-3" value="85" max="100"></progress>
                  </li>
                  <li className="grid lg:grid-cols-3 grid-cols-2 gap-x-2 items-center">
                      <span className="font-semibold">javascript</span>
                      <span className="text-xl lg:block hidden"><i  className="fa-brands fa-js"></i></span>
                      <progress  className="progress progress-warning w-36 h-3" value="65" max="100"></progress>
                  </li>
                  <li className="grid lg:grid-cols-3 grid-cols-2 gap-x-2 items-center">
                  ...
                  <li className="grid lg:grid-cols-3 grid-cols-2 gap-x-2 items-center">
                      ...
                      <span className="text-xl lg:block hidden"><i  className="fa-solid fa-image-landscape"></i></span>
                      <progress  className="progress progress-success w-36 h-3" value="90" max="100"></progress>
                  </li>
                  <li className="grid lg:grid-cols-3 grid-cols-2 gap-x-2 items-center">
                  ...
                  <li className="grid lg:grid-cols-3 grid-cols-2 gap-x-2 items-center">
                      ...
                      <span className="text-xl lg:block hidden"><i  className="fa-brands fa-react"></i></span>
                      <progress  className="progress progress-success w-36 h-3" value="85" max="100"></progress>
                  </li>
                  <li className="grid lg:grid-cols-3 grid-cols-2 gap-x-2 items-center">
                      <span className="font-semibold">React Query</span>
                      <span className="text-xl lg:block hidden"><i  className="fa-brands fa-react"></i></span>
                      <progress  className="progress progress-warning w-36 h-3" value="60" max="100"></progress>
                  </li>
                  <li className="grid lg:grid-cols-3 grid-cols-2 gap-x-2 items-center">
                  ...
                  <li className="grid lg:grid-cols-3 grid-cols-2 gap-x-2 items-center">
                      ...
                      <span className="text-xl lg:block hidden"><i  className="fa-brands fa-node-js"></i></span>
                      <progress  className="progress progress-error w-36 h-3" value="45" max="100"></progress>
                  </li>
                  <li className="grid lg:grid-cols-3 grid-cols-2 gap-x-2 items-center">
